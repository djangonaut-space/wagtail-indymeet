...
class CollectStatsViewIntegrationTests(TestCase):
    ...
    def test_skips_team_whose_project_is_not_a_github_url(self):
        """A team whose project URL is not on GitHub is skipped, leaving no scopes."""
        self.project.url = "https://www.djangoproject.com/"
        self.project.save(update_fields=["url"])
